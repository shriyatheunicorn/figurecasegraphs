...
shutil.copy('/mnt/user-data/uploads/_Figure_Case_Study__Logistics_collect_data.xlsx', '/home/claude/analysis.xlsx')
wb = openpyxl.load_workbook('/home/claude/analysis.xlsx')
ws_raw = wb.active
